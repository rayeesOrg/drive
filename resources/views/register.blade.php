...
<html lang="en"> <!-- .html -->
  ...
  <body>   <!--.body -->
    <div class="container"> <!-- /.Container -->
      <div class="row"> <!-- /.row -->
        <div class="panel panel-default"> <!-- .panel pane-default -->
          <div class="panel-heading">
            ...
            <div class="panel-body"> <!-- .pannel-body -->
              <form class="form-horizontal" method="POST" action="register"> <!-- .form tag -->
                {!! csrf_field() !!}
                  ...
                  <div class="col-md-6"> <!-- .col-md-6 -->
                    ...
                    <div class="form-group">
                      <label for="inputmob_no" class="col-md-4 control-label">Mobile No*</label>
                        <div class="col-md-8">
                          <input type="text" class="form-control" name="mob_no" id="inputmob_no" value="{{ old('mob_no') }}" placeholder="Enter Mobile No...">
                        </div>
                    </div>
